    ...
    <>
      <form onSubmit={handleSubmit} autoComplete="off" className="w-full max-w-none mx-0 px-0 py-6 bg-transparent">
        ...
        <section className="bg-white/70 rounded-lg p-3 border border-blue-100 shadow flex flex-wrap gap-4 items-end mb-2">
          ...
          <div className="flex flex-col w-40 min-w-[120px] ml-auto">
          ...
          <div className="flex flex-col w-32 min-w-[110px] ml-auto">
          ...
          <div className="flex flex-col w-36 min-w-[110px] ml-auto">
          ...
          <div className="flex flex-col w-32 min-w-[100px] ml-auto">
        ...
        {/* Section 3: Ongkos & Biaya */}
        <section className="bg-white/70 rounded-lg p-3 border border-blue-100 shadow flex flex-wrap gap-4 items-end mb-2">
          <div className="flex flex-col w-28 min-w-[80px]">
          ...
          <div className="flex flex-col w-32 min-w-[90px]">
