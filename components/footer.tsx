...
export function Footer() {
  return (
    <footer className="bg-gray-900 text-white py-8 min-h-[200px]">
      <div className="container mx-auto px-4">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="hover:text-primary transition-colors"
                  aria-label="WhatsApp +62 851-1776-6429 (WA Bot)"
                >
              ...
              <li className="flex items-center">
                <MapPin className="h-4 w-4 mr-2 text-primary" /> Jakarta, Bangka Belitung, Kalimantan, Indonesia
              </li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.facebook.com/bangkacargo/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.instagram.com/bce_express/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} BCE EXPRESS. All rights reserved.</p>
          <p className="text-sm mt-1">BETTER CARGO EXPERIENCE</p>
        </div>
      </div>
    </footer>
  )
